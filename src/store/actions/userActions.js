...
const options2 = { style: { 'font':'shabnam', 'textAlign': 'center','color':'#16001E', 'fontFamily':'firstFont', 'fontSize':'14px', 'fontWeight':'bold'}}
...
export const signupAction = (name, email, password, confirmPassword) => {
  return async (dispatch) => {
    ...
    try {
      ...
      dispatch({ type: actions.USER_SIGNUP_FAIL, payload: error.response.data.message });
